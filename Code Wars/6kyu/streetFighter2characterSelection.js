...
function streetFighterSelection(fighters, position, moves){
    ...
    moves.forEach(move => {
        if (move === 'up') {
            selection.push(fighters[0][col])
            row = 0
        }else if (move === 'down') {
            selection.push(fighters[1][col])
            row = 1
        }else if (move === 'left') {
            if (col === 0) col = 5
            else col--
            selection.push(fighters[row][col])
        }else if (move === 'right') {
            if (col === 5) col = 0
            else col++
            selection.push(fighters[row][col])
...
// => ['Ryu', 'Vega', 'Ryu', 'Vega', 'Balrog']
console.log(streetFighterSelection(fighters, [0,0], []))
// => [ ]
console.log(streetFighterSelection(fighters, [0,0], ["left","left","left","left","left","left","left","left"]))
// => ['Vega', 'Balrog', 'Guile', 'Blanka', 'E.Honda', 'Ryu', 'Vega', 'Balrog']
console.log(streetFighterSelection(fighters, [0,0], ["up","left","down","right","up","left","down","right"]))
