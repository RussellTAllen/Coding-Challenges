...
//     if (array1.filter(n => array2.includes(n*n)).length === array1.length) result = true
//     array2.filter(n => array1.includes(Math.sqrt(n))).length === array2.length && result === true ? result = true : result = false
//     console.log(array1.map(n => n*n).sort())
