// Coding Meetup #1 - higher-Order Function Series - Count the number of JS developers coming from Europe - 7 kyu

// rn the number of JavaScript developers coming from Europe.
...
function countDevelopers(list) {
    const filtered = list.filter(person => person.continent === 'Europe' && person.language === 'JavaScript')
